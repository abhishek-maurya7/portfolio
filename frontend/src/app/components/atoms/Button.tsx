...
const classes = cva(
  "px-3 py-2 text-base flex transition-all duration-150 focus:outline-none focus-visible:ring-2 disabled:pointer-events-none",
  {
    variants: {
      variant: {
        primary: cx(
        ...
        secondary: cx(
          "rounded-md",
          "border",
          "border-indigo-600 hover:border-indigo-500 dark:border-indigo-500 dark:hover:border-indigo-400",
